...
import github.viperthanks.shortlink.project.mq.consumer.ShortLinkStatsSaveConsumer;
...
import static github.viperthanks.shortlink.project.common.constant.RedisKeyConstant.SHORTLINK_STREAM_GROUP_KEY;
...
public class RedisStreamConfiguration {
    ...
    public StreamMessageListenerContainer<String, MapRecord<String, String, String>> streamMessageListenerContainer(ExecutorService asyncStreamConsumer) {
        ...
        streamMessageListenerContainer.receiveAutoAck(Consumer.from(SHORTLINK_STREAM_GROUP_KEY, "stats-consumer"),
                StreamOffset.create(SHORTLINK_STREAM_TOPIC_KEY, ReadOffset.lastConsumed()), shortLinkStatsSaveConsumer);
